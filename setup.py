...
def pip_git_to_setuptools_git(url):
    # git+https://github.com/DroneMapp/powerlibs-aws-sqs.git@0.0.1
...
setup(
    name='powerlibs-django-contrib-notifiers',
    version=version,
    description="Models mixins to call notifiers (like SNS or others) on CRUD or others changes to them. ",
    long_description=readme,
    author='Cléber Zavadniak',
    author_email='cleberman@gmail.com',
    url='https://github.com/Dronemapp/powerlibs-django-contrib-notifiers',
    license=license,
    packages=['powerlibs', 'powerlibs.django', 'powerlibs.django.contrib', 'powerlibs.django.contrib.notifiers'],
